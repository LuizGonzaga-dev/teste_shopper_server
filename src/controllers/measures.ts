...
export const upload: RequestHandler = async (req, res) => {
    ...
    const { image, customer_code, measure_datetime, measure_type } = dataIsValid.data;

    //verifica se ja tem leitura no banco de dados
    const measureOnDb = await measureService.thereIsSameMeasureType(customer_code, measure_datetime, measure_type);
...
export const confirm: RequestHandler = async (req, res) => {
    ...
    var updated = await measureService.confirmMeasureValue(measure_uuid, confirmed_value);
...
export const listMeasures : RequestHandler = async (req, res) => {
    ...
    var measures = await measureService.getAllMeasuresFromCustomer(customer_code, measureType);
